...
export const EXAMPLE_RUNS: RunResult[] = [
  ...
  },
  {
    ...
    "insights": [
      ...
      {
        "sourceId": "s7",
        "architecture": "A full-stack monorepo setup that utilizes a unified instructions file (`AGENTS.md`, symlinked to `CLAUDE.md`) read by multiple AI tools like Claude Code, Cursor, Gemini CLI, Kiro, Copilot, and Windsurf.",
